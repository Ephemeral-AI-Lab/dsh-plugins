...
export function registerWriteStdinTool(ctx, service) {
...
function validateWriteArgs(args) {
    if (!/^codex-terminal-[1-9]\d*$/.test(args.job_id)) {
        throw new Error('job_id must be a codex-terminal job id such as codex-terminal-1');
    }
...
function renderOutput(value, jobId) {
    const lines = [];
...
//# sourceMappingURL=write-stdin.js.map