...
| [`dsh-herdr-plus`](./registry/official/dsh-herdr-plus.json) | official | server | Herdr pane state/metadata reporting plus the `herdr` skill and `herdr_agent_*` sibling-session tools |
